...
% and implemented first in https://www.researchsquare.com/article/rs-3399985/v1. Cite the article
% and github URL https://github.com/VVuolanto/Calcium-Imaging for further
% usage.
% Input is a folder containing .csv files obtained from ImageJ image processing software, with use of Time Series Analyzer v3.0 -plugin.
...
% The data is normalized in regards to baseline fluoresence with dF/F0.
